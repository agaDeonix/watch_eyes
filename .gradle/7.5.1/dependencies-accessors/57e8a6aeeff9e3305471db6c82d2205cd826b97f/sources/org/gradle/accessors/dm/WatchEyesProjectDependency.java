...
@NonNullApi
public class WatchEyesProjectDependency extends DelegatingProjectDependency {

    @Inject
    public WatchEyesProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
